        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">
              <span className="bg-gradient-to-r from-ruby-400 to-ruby-600 bg-clip-text text-transparent">Student Capstone Proposals</span>
            </h1>
            <p className="text-gray-400 mt-2 text-sm sm:text-base">View all student capstone proposals and their history</p>
          </div>
          <select
            value={filterStatus}
