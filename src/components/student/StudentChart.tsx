...
export const StudentChart = () => {
  ...
  useEffect(() => {
    ...
    const analyticsData = analyticsService.getStudentAnalytics();
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">
            <span className="bg-gradient-to-r from-ruby-400 to-ruby-600 bg-clip-text text-transparent">Student Analytics</span>
          </h1>
          <p className="text-gray-400 mt-2 text-sm sm:text-base">Track actual system data: students and groups</p>
        </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="bg-gray-800/90 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-lg border-2 border-ruby-600/30">
              ...
              <p className="text-xs sm:text-sm text-gray-400 mb-3 sm:mb-4">Shows actual count of students and student groups in the system</p>
